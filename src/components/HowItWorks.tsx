  ...
  return (
    <section className="py-24 bg-brand-navy text-bg-cream relative overflow-hidden border-t border-brand-navy">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        {/* Traditional Steps with Connecting Line */}
        <div className="relative max-w-4xl mx-auto mb-16">
          <div className="hidden md:block absolute top-[36px] left-16 right-16 h-0.5 bg-bg-cream/15">
            <div
          ...
          <div className="grid md:grid-cols-3 gap-12 text-center">
            {steps.map((item, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-18 h-18 rounded-full flex items-center justify-center mb-6 transition-all duration-300 ${
                      isActive
        ...
        {/* Showcase Deliverables Area card for the current selected tab */}
        <div className="max-w-3xl mx-auto bg-white/5 border border-white/15 p-6 rounded-2xl md:p-8 hover:border-primary/20 transition-all">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 border-b border-white/10 pb-4">
            <div>
              ...
              <h4 className="font-display text-xl font-bold text-white flex items-center gap-2">
                <span>Phase {steps[activeTab].step}</span> • {steps[activeTab].title}
              </h4>
            </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {steps[activeTab].deliverables.map((del, dIdx) => (
              <div key={dIdx} className="bg-brand-navy border border-white/5 p-4 rounded-xl flex flex-col gap-3">
                <span className="w-6 h-6 rounded-full bg-primary/25 text-primary text-xs font-bold inline-flex items-center justify-center shrink-0">
                  ✓
                </span>
