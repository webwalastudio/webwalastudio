    ...
    <section id="services" className="py-24 bg-white border-b border-brand-navy/10 scroll-mt-10">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            {services.map((service) => {
              ...
              return (
                <div
                  ...
                  className={`p-6 rounded-xl border text-left cursor-pointer transition-all duration-300 transform hover:-translate-y-1 ${
                    isSelected
                      ? "bg-brand-navy text-white border-brand-navy shadow-lg"
                      : "bg-bg-cream/40 text-brand-navy border-brand-navy/5 shadow-md hover:shadow-lg"
                  }`}
                >
                  <div
                    className={`w-12 h-12 rounded-full border-2 flex items-center justify-center mb-6 transition-colors ${
          ...
          {/* Interactive Feature Blueprint Drawer */}
